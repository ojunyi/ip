...
public class BuddiBoi {
        ...
        while (true) { 
            ...
            if (input.equals("bye")) {
                ...
                if (taskNumberStr.matches("\\d+") && Integer.parseInt(taskNumberStr) - 1 < itemCount) {
                    ...
                    returnText("Invalid task number due to possible reasons:\n"
                                + " - Empty input\n"
                                + " - Not a number\n"
                ...
                if (!description.isBlank()) {
                    ...
                    // Error handling for invalid task number
                    returnText("Description cannot be empty.\n"
                ...
                if (parts.length == 2) {
                    ...
                    returnText("Invalid deadline format due to possible reasons:\n"
                                + " - No /by was found\n"
                ...
                if (part_1.length == 2) {
                    ...
                    if (part_2.length == 2) {
                        ...
                        returnText("Invalid event format due to possible reasons:\n"
                                    + " - No /to was found\n"
    ...
    public static void markTask(int taskNumber) {
        ...
        returnText("Alright! Done that task shall be:\n  "
                    + tasks[taskNumber].getStatus()
                    + " "
    ...
    public static void unMarkTask(int taskNumber) {
        ...
        returnText("OK. Task shall be undone:  "
                    + tasks[taskNumber].getStatus()
                    + " "
                    + tasks[taskNumber].description());
    }
